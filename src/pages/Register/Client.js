                        ...
                        <div className="container-fluid">
                            <div className="row" id="title-category">
                                <div className="col-sm-8 my-3">
                                    <h4 className="font-card title-category">Clientes</h4>
                                </div>
                                <div className="col-sm-4 my-3">
                                    <h4 className="font-card text-right">
                                        <button onClick={() => collapseRegisters()} type="button" className="btn btn-primary">Adicionar cliente</button>
                                    </h4>
                                </div>
                                        ...
                                        <div className="col-sm-12">
                                            <div className="row">
                                                <div className="col-sm-12 new-category">
                                                    <span className="my-3 title-span-new-category">Novo cliente</span>
                                                </div>
